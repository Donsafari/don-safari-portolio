      ...
      {submitted ? (
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-amber-200 text-stone-950 text-sm font-medium tracking-widest uppercase hover:bg-amber-100 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
