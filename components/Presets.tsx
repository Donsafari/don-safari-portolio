...
const presets = [
  ...
  },
  {
    ...
    description:
      "Night photography is tricky. My presets are not. Tired of everything orange and shadows crushing into nothing. This preset is built to handle all of that with a bit of grit.",
    price: "£4.99",
    tag: "",
